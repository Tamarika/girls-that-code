...
word_count+=tweet[1].split(' ').length
end 

puts word_count 

average=word_count/num_tweets.to_f  #to_f tells ruby to look for decimal numbers as well  - it is enough to add it to one number only)
